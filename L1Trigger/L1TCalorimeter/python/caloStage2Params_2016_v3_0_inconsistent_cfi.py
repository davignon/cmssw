...
caloStage2Params.tauIsoLUTFile                 = cms.FileInPath("L1Trigger/L1TCalorimeter/data/Tau_Iso_LUT_Option_5_NewLayer1Calibration_noCompressionBlock_FW_v5.0.0.txt")
caloStage2Params.tauIsoLUTFile2                = cms.FileInPath("L1Trigger/L1TCalorimeter/data/Tau_Iso_LUT_Option_5_NewLayer1Calibration_noCompressionBlock_FW_v5.0.0.txt")
