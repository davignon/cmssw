...
import L1Trigger.L1Ntuples.l1NtupleProducer_stage2_cfi 
process.l1NtupleProducer = L1Trigger.L1Ntuples.l1NtupleProducer_stage2_cfi.l1NtupleProducer.clone()

# import L1Trigger.L1Ntuples.l1NtupleProducer_Stage1Layer2_cfi 
# process.l1NtupleProducerStage1Layer2 = L1Trigger.L1Ntuples.l1NtupleProducer_Stage1Layer2_cfi.l1NtupleProducer.clone()

process.load("L1Trigger.L1Ntuples.l1RecoTreeProducer_cfi")
process.load("L1Trigger.L1Ntuples.l1ExtraTreeProducer_cfi")
process.load("L1Trigger.L1Ntuples.l1MenuTreeProducer_cfi")
...
#DEBUG
#readFiles = cms.untracked.vstring('file:/eos/uscms/store/user/cbrainer/dataSet/0074D53B-A577-E311-8655-0026189438BD.root')
