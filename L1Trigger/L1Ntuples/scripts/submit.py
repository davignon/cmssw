...
#jobpath=os.environ['CAF_TRIGGER']+"/l1analysis/cmssw/"+os.environ['L1CMSSW']+"/src/UserCode/L1Trigger/test/"
jobpath=os.environ['CMSSW_BASE']+"/src/UserCode/L1Trigger/test/"
